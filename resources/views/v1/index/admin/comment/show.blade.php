        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="card">
                        <div class="header">
                            <h2><strong> کامنت</strong> جزئیات</h2>
                        </div>
                        <div class="tableBody">
                            <div class="table-responsive">
                                <table class="table table-hover dashboard-task-infos">
                                    <lable for="description">متن نظر: </lable><br>
                                    <textarea id="description" readonly>{{$comment->body}}</textarea><br>
                                    ...
                                    <lable>@if(isset($comment->product))عنوان محصول: {{$comment->product['title']. ' '. 'با کد'.$comment->product['sku']}} @else محصول هدف حذف شده است @endif</lable><br>
                                    @if($comment->status==0)
