                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="body">
                            ...
                            <form method="post" action="/admin/category/{{$categoryData->id}}">
                                @csrf
                                {{ method_field('PUT') }}
                                <div class="row clearfix">
                                    <div class="col-sm-12">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="text" class="form-control" name="title" value="{{$categoryData->name}}">
                                                <label class="form-label">عنوان دسته بندی</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="name">تصویر دسته بندی</label>
                                        <img src="{{$categoryData->image->path}}">
                                    </div>
                                    <div class="col-sm-12">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group form-float">
                                            <div class="form-group">
                                                ...
                                                <input type="hidden" name="photo_id" id="category-photo" value="{{$category->image_id}}">
